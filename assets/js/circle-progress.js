...
! function(i) {
    ...
    t.prototype = {
        ...
        initFill: function() {
            ...
            function g() {
                var a = i("<canvas>")[0];
                a.width = e.size, a.height = e.size, a.getContext("2d").drawImage(t, 0, 0, r, r), e.arcFill = e.ctx.createPattern(a, "no-repeat"), e.drawFrame(e.lastFrameValue)
            }
            a.image && (a.image instanceof Image ? t = a.image : (t = new Image).src = a.image, t.complete ? g() : t.onload = g)
        },
        draw: function() {
